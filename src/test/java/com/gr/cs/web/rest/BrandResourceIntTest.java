...
import com.gr.cs.repository.BrandRepository;
...
public class BrandResourceIntTest {
    ...
    private static final String DEFAULT_BRAND_INTRO = "AAAAAAAAAA";
    private static final String UPDATED_BRAND_INTRO = "BBBBBBBBBB";
    ...
    public void createBrand() throws Exception {
        ...
        assertThat(testBrand.getBrandCode()).isEqualTo(DEFAULT_BRAND_CODE);
        assertThat(testBrand.getBrandName()).isEqualTo(DEFAULT_BRAND_NAME);
        assertThat(testBrand.getBrandIntro()).isEqualTo(DEFAULT_BRAND_INTRO);
    }
    ...
    public void getAllBrands() throws Exception {
        ...
        restBrandMockMvc.perform(get("/api/brands?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].brandIntro").value(hasItem(DEFAULT_BRAND_INTRO.toString())));
    }
    ...
    public void getBrand() throws Exception {
        ...
        restBrandMockMvc.perform(get("/api/brands/{id}", brand.getId()))
            ...
            .andExpect(jsonPath("$.brandIntro").value(DEFAULT_BRAND_INTRO.toString()));
    }
    ...
    public void updateBrand() throws Exception {
        ...
        updatedBrand
            ...
            .brandIntro(UPDATED_BRAND_INTRO);
        ...
        Brand testBrand = brandList.get(brandList.size() - 1);
        assertThat(testBrand.getBrandCode()).isEqualTo(UPDATED_BRAND_CODE);
        assertThat(testBrand.getBrandName()).isEqualTo(UPDATED_BRAND_NAME);
        assertThat(testBrand.getBrandIntro()).isEqualTo(UPDATED_BRAND_INTRO);
    }
